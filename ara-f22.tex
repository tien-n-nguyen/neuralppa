...
\begin{center}
{\large \bf Neural Program Analysis Infrastructure and Its Applications}
\end{center}
\vspace{-.1in}
\hrule

PI: Tien N. Nguyen, Professor, Department of Computer Science, The University of Texas at Dallas
...
Amazon contact: Dr. Hoan Anh Nguyen, nguyenanhhoan@gmail.com


\input{sections/ara-abstract}

\input{sections/ara-intro}
\input{sections/ara-fund-request}
%\input{sections/ccf22-related}
%\input{sections/ccf22-approach}
%\input{sections/ccf22-education}
%\input{sections/ccf22-evaluation}
%\input{sections/ccf22-prior}
