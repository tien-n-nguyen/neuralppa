...
%Second, {\em profiling tools} are used to analyze the performance of a
%program by monitoring its resource usage, such as CPU time, memory
%usage, and I/O operations, during runtime. By understanding how the
%program behaves while running, profiling tools can identify
%performance bottlenecks and areas for optimization, enabling
%developers to improve the efficiency of their code. Third,
