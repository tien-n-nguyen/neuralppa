...
%Our tool can also benefit SE tasks such as vulnerability detection (VD), code completion, fault localization, etc., that can tolerate low levels of inaccuracies. 
