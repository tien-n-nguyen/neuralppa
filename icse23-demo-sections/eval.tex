...
%Here, $Precision = \frac{TP}{TP+FP}$, $Recall = \frac{TP}{TP+FN}$, and $F1{-}Score = \frac{2\times Precision\times Recall}{Precision+Recall}$, where $TP$, $FP$, $FN$, $TN$ denote True Positives, False Positives, False Negatives, and True Negatives, respectively.
