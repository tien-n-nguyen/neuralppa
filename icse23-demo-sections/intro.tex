...
from those repositories.  Second, Nguyen {\em et al.}~\cite{icse15}
reported a high repetitiveness level for AST code structure in
open-source projects. Thus, {\tool} infrastructure could
help learn structure-level information from the ASTs extracted for
whole programs in the existing code repositories and infer data types,
partial ASTs for partial programs. Third, in an empirical study on the
