...
\code{conda}\footnote{https://www.anaconda.com/products/distribution} package manager in the Anaconda Python distribution, 
...
\input{icse23-demo-sections/screenshot.tex}
