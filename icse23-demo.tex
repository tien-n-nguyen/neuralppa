...
Code fragments from developer forums often migrate to applications due to the code reuse practice. The incomplete nature of such code fragments makes it challenging for developers to use program analysis (PA) tools to early-determine the presence of potential vulnerabilities. In this work, we present \tool, a neural network-based tool to build control-flow (CFG) and program dependence graphs (PDG) for both complete and partial programs. Our empirical evaluation shows that \tool predicts CFG and PDG edges in complete Java and C/C++ code with combined F-scores of 94.29\% and 92.46\%, respectively. The F-scores for partial Java and C/C++ code range from 94.29\%--97.17\% and 92.46\%--96.01\%, respectively.
...
\input{icse23-demo-sections/intro}
\input{icse23-demo-sections/arch2}
\input{icse23-demo-sections/eval}
\input{icse23-demo-sections/usage}
\input{icse23-demo-sections/related}
\input{icse23-demo-sections/conclusion}
