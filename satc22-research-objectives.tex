...
{\color{red}{\bf FIXME.}} {\em which will allow the construction of
            efficient program analysis techniques for (partial) code,
            also based on which SE applications can be
            built.}
