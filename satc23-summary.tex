...
\begin{center}
  {\bf Project Summary: SaTC: Small: Neural Program Analysis Infrastructure to Support\\ Early Vulnerability Detection for Code Snippets}
\end{center}
\vspace{-.1in}
...
\noindent {\bf Keywords:} Early Vulnerability Detection, Partial Program Analysis, Neural Networks.
