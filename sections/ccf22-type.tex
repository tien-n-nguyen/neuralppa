...
%Therefore, if a user copies the code snippet into an IDE for editing,
%(s)he needs to add the \code{import} statements for the required
%packages in GWT.

Fourth, {\em name ambiguity occurs in the references to external
  libraries}. For example, the type \code{EventListener} at line 2 is
