...
\begin{tabular}[t]{|p{0.2in}|p{2.95in}|}
\hline
\multicolumn{2}{|c|}{\bf T3. XAI-enabled Software Vulnerability Assessment}\\
\hline
{\bf 3.2} & XAI and Vulnerability Assessment\\
{\bf 3.3} & Text Generation for Explanations\\
...
\begin{tabular}[t]{|p{0.2in}|p{2.95in}|}
\hline
\multicolumn{2}{|c|}{\bf T4. XAI-enabled Binary Vulnerability Detection}\\
\hline
%{\bf 3.1} & Design New Code Representations\\

{\bf 4.1} & Binary Vulnerablity Detection with {\tool}\\
{\bf 4.2} & XAI for Binary Vulnerability Detection\\
